...
const TRANSLATIONS = {
  en: {
    ...
    footer_col1_desc: "A Smart Urban Governance & Vendor Empowerment Initiative designed for Nagpur City. Developed by 3rd Year AI & DS Students in academic collaboration with Nagpur Municipal Corporation.",
    footer_student_dev: "🎓 Developed by: Department of AI & DS, Nagpur",
    footer_academic_note: "K.D.K. College of Engineering, Nagpur 3rd Year Project 2026-27",
    ...
    dossier_intro: "<strong>Project Name:</strong> LokVyapar - Smart Urban Street Vendor Footfall & UPI Intelligence Platform.<br />Developed by 3rd year <strong>B.Tech AI & DS</strong> students in academic collaboration with Nagpur Municipal Corporation.",
    dossier_inst_lbl: "Academic Institution & Department",
    dossier_inst_val: "Department of AI & DS, Nagpur",
    dossier_batch_lbl: "Academic Year & Batch",
    dossier_batch_val: "3rd Year (2026-2027)",
    dossier_mentor_lbl: "Project Mentors",
    dossier_mentor_val: "Faculty Guides & Executive Director",
